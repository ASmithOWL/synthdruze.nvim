...
local function setup(c)
	return {
		...
		Identifier = { fg = c.vaporberry }, -- *Identifier	any variable name
		...
		Keyword = { fg = c.pineapple }, --  Keyword	any other keyword
		...
		Structure = { fg = c.salmon }, --  Structure	struct, union, enum, etc.
		Typedef = { fg = c.salmon }, --  Typedef	A typedef
		...
		Delimiter = { fg = c.mandarin }, --  Delimiter	character that needs attention
